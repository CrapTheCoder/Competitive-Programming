...
int main()
{
    ...
    while(t--)
    {
        ...
        for(int i = 0; i < v.size(); i++){
            ...
            int c_right = 0; // The rightmost column within a square (Can be negative)

            /// NOTE: A negative c_left or c_right value means to the left
            ...
            for(int j = i; j < v.size(); j++){
                ...
                /// Here, the differences between the leftmost value and the rightmost value would do the trick
